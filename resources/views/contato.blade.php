...
<head>
    ...
    <title>Fale Conosco - Suporte de Manutenção</title>
...
<main>
        <div class="container">
            <div class="container-fluid py-5">
                <h1 class="display-5 fw-bold text-center" >Fale Conosco</h1>
        ...
        <div class="container">
            <form class="was">
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control is" id="validationTextarea" placeholder="Insira aqui sua dúvida e/ou sugestão" required></textarea>
                </div>
                <br>
